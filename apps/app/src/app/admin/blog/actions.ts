...
// Blog objave žive na root nivou marketing sajta (/{slug}, ne /blog/{slug}) —
// slug ne sme da se poklopi sa statičkom rutom, inače objava postaje nedostupna.
...
export async function createPost(formData: FormData) {
  ...
  if (RESERVED_SLUGS.has(input.slug)) {
    backWithError(
      "/admin/blog/novo",
      `Slug "${input.slug}" je rezervisan za stranicu sajta — izaberi drugi.`,
    );
  }
