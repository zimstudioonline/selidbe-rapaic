 ...
 * upisuje red u Google Sheet i šalje email obaveštenje (vidi uputstvo za
 * podešavanje skripte). Direktan POST na Google Forms formResponse endpoint
 * ne radi pouzdano (Google ga blokira sa 401 za zahteve bez validne sesije),
 * zato ide preko Apps Script-a. redirect() je namerno VAN try bloka (interno
 * radi kroz throw — catch bi ga progutao).
 */
